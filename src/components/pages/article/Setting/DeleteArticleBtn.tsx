...
import { softDeleteArticleAction } from "@/stores/articles/actions";

//Constants
import { PATHS } from "@/common/constants";

export const DeleteArticleBtn = () => {
  //Redux
  ...
  async function deleteArticleHandler() {
    setIsLoading(true);
    try {
      await dispatch(softDeleteArticleAction(params.slug as string));
      setIsLoading(false);
