...
export const ImagesSection = () => {
  return (
    <div className="md:col-span-6 mb-12 md:mb-0 w-full max-w-[326px] md:max-w-full">
      <div className="flex-1 grid grid-cols-3 grid-rows-10 gap-2 xl:gap-3 w-full h-60 px-8 lg:h-96 xl:h-[500px]">
