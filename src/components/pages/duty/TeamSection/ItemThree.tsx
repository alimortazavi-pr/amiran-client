      ...
      <div className="flex gap-3 md:gap-6">
        <div className="flex-1 flex flex-col gap-1 mt-8">
          <div className="md:flex items-center justify-between">
            <h6 className="text-lg font-bold tracking-[20px] md:tracking-normal lg:tracking-[15px]">
              VAHI<span className="!tracking-normal">D</span>
            </h6>
            <h6 className="hidden md:block">-</h6>
            <h6 className="text-lg font-bold tracking-[5px] md:tracking-normal lg:tracking-[15px]">
