      ...
      <div className="flex gap-3 md:gap-6">
        <div className="flex-1 flex flex-col gap-1 mt-8">
          ...
          <p className="text-primary/30 text-sm text-justify md:text-lg font-light">
            <span className="font-bold text-primary">Managing Director, </span>
            With a degree in Civil Engineering and Executive Management, and
            holding a Grade 1 license from the Engineering Organization, he is a
            certified qualified contractor with expertise in managing
