          ...
          <div className="md:flex items-center justify-between">
            <h6
              className={`text-lg font-bold ${
                i18n.language === "en" &&
                "tracking-[15px] md:tracking-normal lg:tracking-[15px]"
              }`}
            >
              {t("DUTY.TEAM.TeamItem2Name1_Label")}
              <span className="!tracking-normal">
                {t("DUTY.TEAM.TeamItem2Name2_Label")}
              </span>
            </h6>
            ...
            >
              {t("DUTY.TEAM.TeamItem2Family1_Label")}
              <span className="!tracking-normal">
                {t("DUTY.TEAM.TeamItem2Family2_Label")}
              </span>
            </h6>
          </div>
          <p className="text-primary/30 text-sm text-justify md:text-lg font-light">
            <span className="font-bold text-primary">
              {t("DUTY.TEAM.TeamItem2Position_Label")}{" "}
            </span>
            {t("DUTY.TEAM.TeamItem2Description_Label")}
          </p>
        </div>
